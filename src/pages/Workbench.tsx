export function Workbench() {
  return (
    <div className="mx-auto grid w-full max-w-6xl gap-6 md:grid-cols-[1fr_260px]">
      <section className="min-w-0 rounded-lg border border-[var(--border)] bg-[var(--bg)] p-4 shadow-sm">
      ...
      <aside className="rounded-lg border border-[var(--border)] bg-[var(--bg)] p-4 shadow-sm md:min-w-0">
